...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Coder_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Coder_t qt_meta_stringdata_Coder = {
    {
QT_MOC_LITERAL(0, 5) // "Coder"
...
const QMetaObject Coder::staticMetaObject = { {
    ...
    qt_meta_stringdata_Coder.offsetsAndSize,
    qt_meta_data_Coder,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Coder_t
, QtPrivate::TypeAndForceComplete<Coder, std::true_type>
